...
export default function Projects() {
  return (
    <section id="projects" className="relative overflow-hidden bg-[#071313] py-12 md:py-28">
        ...
        <div className="grid sm:grid-cols-2 lg:grid-cols-3 gap-6">
          {projects.slice(0, 3).map((p, i) => (
            <Reveal key={p.id} delay={i * 0.08}>
              <div className="group overflow-hidden rounded-2xl border border-[#7CFF00]/20 bg-[#0d1c16]">
                ...
                <div className="p-5">
                  ...
                  <h3 className="text-lg font-bold mt-1 mb-1.5 font-display text-white">{p.title}</h3>
