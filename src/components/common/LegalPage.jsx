      ...
      <section className="relative overflow-hidden bg-surface-bg so-section">
        ...
        <Container className="relative z-10 max-w-2xl">
          ...
          <p className="text-sm text-ink-muted pt-4 border-t border-line">
            Questions? Contact{" "}
            <a href={`mailto:${CONTACT.email}`} className="text-brand-primary underline decoration-dotted">{CONTACT.email}</a>{" "}
            or call <a href={CONTACT.phoneHref} className="text-brand-primary underline decoration-dotted">{CONTACT.phoneDisplay}</a>.
          </p>
        </Container>
      </section>
    </>
